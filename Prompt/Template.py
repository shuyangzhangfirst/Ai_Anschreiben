...
class PromptTemplate:
    ...
    def add_person_information(self,name:str=None,age:int=None,phone_number:str=None,email:str=None):
        if name is not None:
    ...
    def set_target_job(self,jobtitle:str,jobdescription:str,companyname:str):
        self.target_job=jobinfo(jobtitle,jobdescription,companyname)
